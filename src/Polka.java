 ...
 */
public class Polka extends JPanel{
    ...
    public Polka(int pojemnosc, JLabel komunikat, int iloscKonsumentow) {
    ...
    synchronized void czytajWiadomosc(Konsument konsument){
